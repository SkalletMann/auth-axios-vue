    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <p v-if="!$v.email.unique">I'm sorry but this email is already taken</p>
        </div>
        <div class="input" :class="{invalid: $v.age.$error}">
          ...
          <input
                  ...
                  @blur="$v.age.$touch()"
                  v-model.number="age">
          <p v-if="$v.age.$error">You have to be at least {{$v.age.$params.minVal.min}} years old.</p>
        </div>
        ...
        <div class="hobbies">
          ...
          <div class="hobby-list">
            <div
              ...
              <p v-if="$v.hobbyInputs.$each[index].value.$model.length <=4">Hobbie should have at least {{$v.hobbyInputs.$each[index].value.$params.minLen.min}} characters.</p>
            </div>
